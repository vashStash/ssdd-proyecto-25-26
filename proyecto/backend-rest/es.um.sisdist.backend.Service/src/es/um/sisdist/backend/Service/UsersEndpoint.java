...
public class UsersEndpoint
{
    ...
    @POST
    @Path("/{username}/profile/cambiar_datos")
    @Produces(MediaType.APPLICATION_JSON)
    public Response cambiarNombre(@PathParam("userid") String userid, UserDTO userDTO){
        ...
        if(impl.updateUser(user.get(), userDTO.getName())){
